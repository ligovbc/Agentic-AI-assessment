...
class ChainOfThoughtEngine:
    ...
    def generate_cot_steps(self, prompt: str, num_steps: int) -> List[ChainOfThoughtStep]:
        """
        ...
        Returns:
            List of ChainOfThoughtStep objects
        """
        steps = []
    ...
    def generate_final_answer(self, prompt: str, cot_steps: List[ChainOfThoughtStep]) -> tuple[str, float]:
        """
...
{{"answer": "your final answer here", "confidence": 85}}"""
    ...
    async def agenerate_cot_steps(self, prompt: str, num_steps: int) -> List[ChainOfThoughtStep]:
        """
        Async version: Generate chain-of-thought reasoning steps for a given prompt
    ...
    async def agenerate_final_answer(self, prompt: str, cot_steps: List[ChainOfThoughtStep]) -> tuple[str, float]:
        """
        Async version: Generate final answer based on chain-of-thought steps
